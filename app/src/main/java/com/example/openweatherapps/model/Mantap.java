...
public class Mantap implements Parcelable
{
    ...
    @Expose
    private Integer cod;
    public final static Creator<Mantap> CREATOR = new Creator<Mantap>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Mantap createFromParcel(android.os.Parcel in) {
            return new Mantap(in);
        }

        public Mantap[] newArray(int size) {
            return (new Mantap[size]);
        }

    }
    ;

    protected Mantap(android.os.Parcel in) {
        this.coord = ((Coord) in.readValue((Coord.class.getClassLoader())));
        in.readList(this.weather, (com.example.openweatherapps.model.Weather.class.getClassLoader()));
     ...
     * @param wind
     */
    public Mantap(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
    ...
    public String toString() {
        ...
        sb.append(Mantap.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("coord");
        sb.append('=');
